...
// Cria uma "preference" (uma cobrança) no Mercado Pago pra um presente específico.
// externalReference = id do presente no nosso banco, pra sabermos qual presente
// foi pago quando o webhook chegar.
export async function criarPreferencia({ gift, compradorNome }) {
